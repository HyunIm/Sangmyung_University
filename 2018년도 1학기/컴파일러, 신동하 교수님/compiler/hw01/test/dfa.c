...
#define NO_ALPHABET 2	// 입력 심볼의 유한 집합 개수
#define NO_STATES 2	// 상태의 유한 집합 개수

int alphabet[NO_ALPHABET] = {'0', '1'};	// 입력 심볼의 유한 집합

int starting_state = 0;	// 시작 상태

int accepting_states[NO_STATES] = {1, 0};	// 최종 상태들의 집합
