...
<details>
  ...
  <ol>
    <li>
      <a href="#2015년도-1학기">2015년도 1학기</a> (1학년 1학기)
      <ul>
        <li>미적분학, 박종환 교수님</li>
        <li>컴퓨터기초원리, 홍철의 교수님</li>
      </ul>
    </li>
    <li>
      <a href="#2015년도-2학기">2015년도 2학기</a> (1학년 2학기)
      <ul>
        <li>공학설계입문, 배경율 교수님</li>
        <li>보안기초수학, 박종환 교수님</li>
        <li>프로그래밍I, 이의철 교수님</li>
      </ul>
    </li>
    <li>
      <a href="#2016년도-1학기">2016년도 1학기</a> (2학년 1학기)
      <ul>
        <li>논리회로, 민승욱 교수님</li>
        <li>선형대수학, 이의철 교수님</li>
        <li>시스템소프트웨어, 손성훈 교수님</li>
        <li>이산수학, 김윤호 교수님</li>
        <li>프로그래밍2, 홍철의 교수님</li>
      </ul>
    </li>
    <li>
      <a href="#2016년도-2학기">2016년도 2학기</a> (2학년 2학기)
      <ul>
        <li>객체지향프로그래밍, 김영준 교수님</li>
        <li>데이터통신, 정진우 교수님</li>
        <li>운영체제, 손성훈 교수님</li>
        <li>자료구조, 홍철의 교수님</li>
        <li>컴퓨터구조, 김성철 교수님</li>
    ...
    <li>
      <a href="#2017년도-1학기">2017년도 1학기</a> (3학년 1학기)
      <ul>
        <li>데이터베이스, 송병호 교수님</li>
        <li>소프트웨어공학, 한혁수 교수님</li>
        <li>알고리즘, 홍철의 교수님</li>
        <li>유닉스프로그래밍, 백윤철 교수님</li>
        <li>인공지능, 김영준 교수님</li>
        <li>컴퓨터네트워크, 김성철 교수님</li>
      </ul>
    </li>
    <li>
      <a href="#2017년도-2학기">2017년도 2학기</a> (3학년 2학기)
      <ul>
        <li>게임소프트웨어디자인1, 김석규 교수님</li>
        <li>디지털신호처리, 이의철 교수님</li>
        <li>프로그래밍언어론, 신동하 교수님</li>
        <li>휴먼컴퓨터인터렉션, 한혁수 교수님</li>
      </ul>
    </li>
    <li>
      <a href="#2018년도-1학기">2018년도 1학기</a> (4학년 1학기)
      <ul>
        <li>미적분학, 이석필 교수님</li>
        <li>보안프로그래밍, 강상욱 교수님</li>
        <li>임베디드소프트웨어I, 신동하 교수님</li>
        <li>캡스톤디자인I, 한혁수 교수님</li>
        <li>컴파일러, 신동하 교수님</li>
        <li>통계, 유훈 교수님</li>
      </ul>
    </li>
    <li>
      <a href="#2018년도-2학기">2018년도 2학기</a> (4학년 2학기)
      <ul>
        <li>인공지능 사회, 권지은 교수님</li>
        <li>캡스톤디자인II, 한혁수 교수님</li>
      </ul>
    </li>
  </ol>
</details>
...
<details>
  <summary>과제</summary>
  <ul>
    <li>1.3 역삼각함수, 1.4 쌍곡선함수와 역함수</li>
    <li>1.8 극 좌표</li>
    <li>2.4 삼각함수의 도함수</li>
    <li>2.5 초월함수의 도함수</li>
    <li>4.2 치환적분법, 4.3 부분적분법</li>
    <li>4.4 유리함수의 적분법</li>
    <li>4.5 삼각함수의 적분법</li>
    <li>5.5 이상적분</li>
    <li>6.1 평면의 넓이, 6.3 입체도형의 부피Ⅱ (원기둥에 의한 방법)</li>
    <li>7.2 양항급수의 수렴판정법</li>
    <li>7.3 교대급수와 절대급수</li>
  </ul>
</details>
<br>
...
<details>
  ...
  <ul>
    <li>거리 변환 프로그램.c</li>
    <li>두 정수를 입력받아 차의 절대값 출력.c</li>
    <li>두 정수를 입력받아 큰 수를 출력.c</li>
    <li>온도 변환 프로그램 작성.c</li>
  </ul>
</details>
<br>
